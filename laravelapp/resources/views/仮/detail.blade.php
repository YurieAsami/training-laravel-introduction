          ...
          <div class="swiper-container border rounded mb-2" id="detail-slider">
            <div class="swiper-wrapper">
              @php
                $i=1;;
              @endphp
              @while(isset("/img/product/pro".$product->id."-large-."$i.".jpg"))
          ...
          <table class="table table-detail">
            <tbody>
                ...
                <td>
                  <ul class="list-inline mb-0">
                    @if(isset($product->sale))
                      ...
                      @endphp
                    <li class="list-inline-item"><span class="text-theme h5">{{$prices}}円</span></li>
                    <li class="list-inline-item"><del class="text-muted">{{$product->price}}円</del></li>
              ...
              <tr>
                ...
                <td>
                  @if($product->stock ==0)
                    <span class="badge badge-success">Not Stock</span>
                  @else
