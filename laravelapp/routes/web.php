...
Route::post('test/purchase','ShoppingController@testpurchase');
...
Route::post('test/wishdrop', 'ShoppingController@testwishdrop');
Route::get('test/profile','ShoppingController@testprofile');
Route::post('test/profile','ShoppingController@testprofileedit');
Route::get('test/password','ShoppingController@testpassword');
Route::post('test/password','ShoppingController@testpassedit');
Route::get('test/order','ShoppingController@testorder');
Route::get('test/address','ShoppingController@testaddress');
Route::post('test/address','ShoppingController@testaddressedit');
